...
void solve(){
    ...
    cin>>n>>d;
    set<ll> res;
    // if(d%2==0)res.insert(2);
    if(1)res.insert(1);
    if(d%3==0||(n>=3))res.insert(3);
    if(d%9==0||(n>=6)||(d%3==0&&n>=3))res.insert(9);
    // if(((d*100)+(d*10)+d)%8==0&&n>2)res.insert(8);
    // if(((d*10)+d)%4==0)res.insert(4);
    // if(((d*10)+d)%8==0&&n==2)res.insert(8);
    if(d%5==0)res.insert(5);
    // if(d%2==0&&(d%3==0||n>=3))res.insert(6);
    if(d%7==0||(n>=3))res.insert(7);
